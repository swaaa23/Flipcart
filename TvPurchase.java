...
public class TvPurchase {
	...
	public void methodC() throws Exception {
		...
		//String strText = driver.findElement(("//span[@class='B_NuCI')]").getText().toString());
		 ...
		 /*File f = new File("C:\\Users\\HP\\Documents\\mobilepurchase.xlsx");
	...
	public void methodE() throws Exception{
		...
		File target = new File("C:\\Users\\HP\\workspace\\eclipse\\JunitJuly\\Screenshots\\TV.png");
